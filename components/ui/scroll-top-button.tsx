  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="w-14 h-14 bg-gradient-to-br from-[#A3B18A] to-[#DFF19D] rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:scale-110 flex items-center justify-center">
          {/* Animated border ring */}
          <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[#A3B18A] to-[#DFF19D] opacity-0 group-hover:opacity-100 transition-opacity duration-300 animate-pulse"></div>
        ...
        <div className="absolute -top-1 -right-1 opacity-0 group-hover:opacity-100 transition-all duration-300 transform group-hover:scale-110">
          <Sparkles className="w-4 h-4 text-[#F6CCD0] animate-pulse" />
        </div>
        
        {/* Secondary floating element */}
        <div className="absolute -bottom-1 -left-1 opacity-0 group-hover:opacity-100 transition-all duration-500 transform group-hover:scale-110 delay-100">
          <div className="w-3 h-3 bg-[#BFF0F5] rounded-full animate-pulse"></div>
        </div>
      ...
      <div className={`absolute inset-0 rounded-2xl bg-white opacity-0 ${isAnimating ? "animate-ping" : ""}`}></div>
    </button>
  );
}