        ...
        <div className="mb-8">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 bg-[#A3B18A]/10 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-sm font-medium text-[#A3B18A]">Profil Pengguna</span>
            </div>
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Selamat Datang, <span className="text-[#A3B18A]">{userProfile.fullName.split(' ')[0]}</span>
            </h1>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-3xl p-6 shadow-lg">
              ...
              <div className="text-center mb-6 pb-6 border-b border-gray-200">
                ...
                <h3 className="font-bold text-gray-900">{userProfile.fullName}</h3>
                ...
                <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-gradient-to-r from-[#A3B18A] to-[#DFF19D] rounded-2xl p-6 text-white">
                      ...
                      <div className="text-3xl font-bold">{userProfile.totalOrders}</div>
                      <div className="text-white/80 text-sm">Sejak bergabung</div>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-[#F6CCD0] to-[#BFF0F5] rounded-2xl p-6 text-white">
                      ...
                      <div className="text-3xl font-bold">Rp {(userProfile.totalSpent / 1000)}k</div>
                      <div className="text-white/80 text-sm">Lifetime value</div>
                    </div>

                    <div className="bg-gradient-to-r from-[#BFF0F5] to-[#A3B18A] rounded-2xl p-6 text-white">
                      <div className="flex items-center gap-3 mb-3">
                        <Gift className="w-6 h-6" />
                        <span className="font-semibold">Poin Loyalitas</span>
                      </div>
                      <div className="text-3xl font-bold">{userProfile.loyaltyPoints}</div>
                      <div className="text-white/80 text-sm">Tukar dengan hadiah</div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      {orders.slice(0, 3).map((order) => (
                        <div key={order.id} className="border border-gray-200 rounded-2xl p-4 hover:border-[#A3B18A] transition-colors">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <button
                        onClick={() => setActiveTab("orders")}
                        className="flex flex-col items-center gap-3 p-6 border border-gray-200 rounded-2xl hover:border-[#A3B18A] hover:bg-[#A3B18A]/5 transition-all"
                      >
                        <Package className="w-8 h-8 text-[#A3B18A]" />
                        <span className="font-semibold text-gray-900">Lacak Pesanan</span>
                      </button>
                      <button
                        onClick={() => setActiveTab("addresses")}
                        className="flex flex-col items-center gap-3 p-6 border border-gray-200 rounded-2xl hover:border-[#A3B18A] hover:bg-[#A3B18A]/5 transition-all"
                      >
                        <MapPin className="w-8 h-8 text-[#A3B18A]" />
                        <span className="font-semibold text-gray-900">Kelola Alamat</span>
                      </button>
                      <button className="flex flex-col items-center gap-3 p-6 border border-gray-200 rounded-2xl hover:border-[#A3B18A] hover:bg-[#A3B18A]/5 transition-all">
                        <Heart className="w-8 h-8 text-[#A3B18A]" />
                        <span className="font-semibold text-gray-900">Wishlist</span>
                      </button>
                      <button className="flex flex-col items-center gap-3 p-6 border border-gray-200 rounded-2xl hover:border-[#A3B18A] hover:bg-[#A3B18A]/5 transition-all">
                        <Award className="w-8 h-8 text-[#A3B18A]" />
                        <span className="font-semibold text-gray-900">Tukar Poin</span>
                      </button>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-[#A3B18A]/5 rounded-2xl p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <div className="font-semibold text-gray-900">{userProfile.id}</div>
                      </div>
                      <div>
                        <span className="text-gray-600">Status Akun:</span>
                        <div className="flex items-center gap-2">
                          <CheckCircle className="w-4 h-4 text-green-600" />
                          <span className="font-semibold text-green-600">Terverifikasi</span>
                        </div>
                      </div>
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <Star className="w-4 h-4 text-yellow-500" />
                          <span className="font-semibold text-[#A3B18A]">Gold Member</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {activeTab === "orders" && (
                <div className="space-y-8">
                  ...
                  <div className="space-y-6">
                    {orders.map((order) => (
                      <div key={order.id} className="border border-gray-200 rounded-2xl p-6 hover:border-[#A3B18A] transition-colors">
