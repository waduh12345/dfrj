...
export default function SitemapPage() {
  ...
  return (
    <div
      className={`min-h-screen bg-gradient-to-b from-white to-[#FFF0F5] text-gray-700 font-sans selection:bg-[#d43893ff] selection:text-white relative overflow-hidden ${sniglet.className}`}
    >
      ...
      <section className="pt-28 pb-12 px-6 lg:px-12 text-center relative z-10">
        ...
        <h1
          className={`text-4xl lg:text-6xl font-bold text-[#5B4A3B] mb-6 tracking-tight ${fredoka.className}`}
        >
          Peta Situs
        </h1>
        <p className="text-gray-500 text-lg max-w-xl mx-auto leading-relaxed">
          Navigasi lengkap untuk menjelajahi ekosistem pemberdayaan{" "}
          <span className="text-[#d43893ff] font-bold">Radja Mart</span>.
        </p>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 auto-rows-fr">
            ...
            <div className="lg:col-span-2 bg-white rounded-[2.5rem] p-8 lg:p-10 shadow-xl shadow-pink-100/50 border border-pink-50 flex flex-col justify-between hover:-translate-y-1 transition-transform duration-300">
              <div>
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <span
                    className={`text-2xl font-bold text-[#5B4A3B] ${fredoka.className}`}
                  >
                    Radja Mart
                  </span>
                </div>
                <h2
                  className={`text-2xl font-bold text-[#5B4A3B] mb-4 ${fredoka.className}`}
                >
                  Karya & Kemandirian
                </h2>
                <p className="text-gray-500 leading-relaxed mb-8 max-w-md">
                  Wadah kewirausahaan sosial yang menghadirkan produk kuliner
                  otentik, kriya handmade, dan fashion berkualitas karya
                  difabelpreneur Indonesia.
                </p>
              </div>
            ...
            <div className="bg-gradient-to-br from-[#d43893ff] to-[#b02e7a] text-white rounded-[2.5rem] p-8 lg:p-10 shadow-xl shadow-pink-200 lg:row-span-2 flex flex-col relative overflow-hidden group">
              ...
              <h3
                className={`text-2xl font-bold mb-8 flex items-center gap-3 relative z-10 ${fredoka.className}`}
              >
            ...
            <div className="bg-white rounded-[2.5rem] p-8 shadow-xl shadow-pink-100/50 border border-pink-50 hover:-translate-y-1 transition-transform duration-300">
              <h3
                className={`text-xl font-bold text-[#5B4A3B] mb-6 flex items-center gap-2 ${fredoka.className}`}
              >
            ...
            <div className="lg:col-span-2 bg-white rounded-[2.5rem] p-8 lg:p-10 shadow-xl shadow-pink-100/50 border border-pink-50 relative overflow-hidden hover:-translate-y-1 transition-transform duration-300 group">
              ...
              <h3
                className={`text-xl font-bold text-[#5B4A3B] mb-6 flex items-center gap-3 ${fredoka.className}`}
              >
            ...
            <div className="bg-[#2a221b] text-gray-300 rounded-[2.5rem] p-8 shadow-xl flex flex-col justify-center relative overflow-hidden group hover:shadow-2xl transition-all duration-300">
              ...
              <h3
                className={`text-white font-bold mb-6 text-lg tracking-wide border-b border-gray-700 pb-2 ${fredoka.className}`}
              >
                Legalitas
              </h3>
