      ...
      <section className="relative bg-gradient-to-br from-[#d43893ff] to-[#a0226d] text-white pt-32 pb-20 px-6 lg:px-12 overflow-hidden rounded-b-[3rem]">
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          <p className="text-lg text-white/90 max-w-2xl mx-auto leading-relaxed font-light">
            Di <strong>Radja Mart</strong>, kepercayaan Anda adalah amanah bagi
            kami. Dokumen ini menjelaskan bagaimana kami menjaga dan mengelola
            data pribadi Anda dalam setiap transaksi karya difabelpreneur.
          </p>
      ...
      <section className="px-6 lg:px-12 py-16">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="bg-white border border-[#d43893ff]/20 rounded-[2rem] p-8 lg:p-10 shadow-xl shadow-pink-100/50 mb-10">
            <h2
              className={`text-2xl font-bold text-[#d43893ff] mb-4 flex items-center gap-3 ${fredoka.className}`}
            >
            ...
            <p className="leading-loose text-[#5B4A3B]">
              ...
              menggunakannya untuk memberikan layanan terbaik bagi Anda.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            ...
            <div className="bg-[#FFF0F5] rounded-[2rem] p-8 border border-pink-100 hover:shadow-lg transition-all duration-300">
              ...
              <h3
                className={`text-xl font-bold text-[#5B4A3B] mb-4 ${fredoka.className}`}
              >
              ...
              <ul className="space-y-3 text-sm text-[#5B4A3B]/80">
                <li className="flex gap-3">
                  ...
                  <span>
                    <strong>Identitas & Kontak:</strong> Nama lengkap, alamat
                    email, dan nomor WhatsApp (untuk koordinasi pengiriman).
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#d43893ff] mt-1">●</span>
                  <span>
                    <strong>Alamat Pengiriman:</strong> Detail lokasi untuk
                    memastikan produk kuliner/kriya sampai dengan aman.
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#d43893ff] mt-1">●</span>
                  <span>
                    <strong>Riwayat Pesanan:</strong> Daftar karya yang pernah
                    Anda beli untuk rekomendasi di masa depan.
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#FFF0F5] rounded-[2rem] p-8 border border-pink-100 hover:shadow-lg transition-all duration-300">
              ...
              <ul className="space-y-3 text-sm text-[#5B4A3B]/80">
                <li className="flex gap-3">
                  <span className="text-[#d43893ff] mt-1">●</span>
                  <span>
                    Memproses transaksi dan mengatur pengiriman ekspedisi/kurir.
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#d43893ff] mt-1">●</span>
                  <span>
                    Mengirimkan update status pesanan (resi) melalui Email atau
                    WhatsApp.
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-[#d43893ff] mt-1">●</span>
                  <span>
                    Meningkatkan kualitas layanan dan variasi produk
                    difabelpreneur.
                  </span>
                </li>
              </ul>
          ...
          <div className="space-y-8 bg-white p-8 lg:p-10 rounded-[2.5rem] shadow-xl shadow-gray-100 border border-gray-50">
            <div className="group">
              <h2
                className={`text-2xl font-bold text-[#5B4A3B] mb-4 flex items-center gap-4 ${fredoka.className}`}
              >
            ...
            <div className="group">
              ...
              <p className="leading-loose pl-0 lg:pl-16 text-gray-600">
                Anda memiliki hak penuh atas data Anda. Jika Anda ingin mengubah
                informasi akun, menghapus data, atau berhenti berlangganan
                newsletter kami, Anda dapat melakukannya kapan saja melalui
                pengaturan akun atau menghubungi tim kami.
              </p>
            </div>
          </div>
          ...
          <div className="mt-16 bg-gradient-to-r from-[#d43893ff] to-[#a0226d] rounded-[2.5rem] p-10 md:p-14 text-center text-white shadow-2xl shadow-pink-200 relative overflow-hidden">
            <div className="relative z-10">
              <h2 className={`text-3xl font-bold mb-4 ${fredoka.className}`}>
